                    ...
                    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex items-start space-x-2">
                                ...
                                <label htmlFor="agreeToTerms" className="text-sm text-amber-900">I agree to the{''}
                                    <a href="#" className="text-amber-600 hover:text-amber-700"> Terms of Service</a>{''} and {''}
                                    <a href="#" className="text-amber-600 hover:text-amber-700">Privacy Policy</a>
                                </label>
                            </div>

                            <button type="button" className="w-full bg-amber-600 text-white py-3 rounded-md hover:bg-amber-700 transition-colors font-medium cursor-pointer">
                                Create Account
                            </button>
                            ...
                            <div className="text-center mt-6">
                               ...
                               <Link to="/login"><a href="#" className="text-amber-800 hover:text-amber-500 font-medium"> Sign in</a></Link>
                                </p>
                            </div>
                        </div>
                    </div>
